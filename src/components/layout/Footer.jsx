...
export default function Footer() {
  return (
    <footer className="bg-[#060c1a] border-t border-[#0f1e3a] py-6 sm:py-8">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 flex flex-wrap justify-center gap-5 sm:gap-8">
